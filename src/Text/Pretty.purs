...
import Data.List.Reversed as List.List
import Data.List.Reversed as List.List.ReversedList
...
instance Pretty a => Pretty' (List.List.ReversedList a) String where pretty' sep xs = "[" <> List.intercalate sep (pretty <$> List.List.ReversedList.unreverse xs) <> "]"
